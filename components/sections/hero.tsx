      ...
      <div className="container mx-auto px-4 z-10 relative">
        ...
        >
          ...
          >
            ...
            >
            <span
              className="glitch whitespace-normal lg:whitespace-nowrap"
              data-text="Sachitha Samadhi">
              Sachitha Samadhi
            </span>

            </RevealElement>

            <RevealElement className="mb-8 max-w-xl" delay={0.3} direction="up" stayVisible={true}>
              <p className="text-xl md:text-2xl text-zinc-400 font-light">
                I create digital experiences that challenge the ordinary.
              </p>
            </RevealElement>

            <RevealElement className="flex items-center gap-8 mt-4 mb-12" delay={0.4} direction="up" stayVisible={true}>
            ...
            <RevealElement delay={0.6} direction="up" stayVisible={true}>
              <AnimatedButton
                variant="gradient"
                size="xl"
